<template>
  <div class="conctract">
    ...
    <p>
      ...
      şartları kabul etmiş varsayılmaktadır: <br />

      Sitemizdeki web sayfaları ve ona bağlı tüm sayfalar www.beeconcrete.comtr
      adresindeki CTV inşaat sanayii ve TİC. LTD. ŞTİ. firmasının malıdır ve
      onun tarafından işletilir. Sizler sitede sunulan tüm hizmetleri
      ...
      yükümlülükler yükler ve taraflar işbu sözleşmeyi kabul ettiklerinde bahsi
      geçen hak ve yükümlülükleri eksiksiz, doğru, zamanında, işbu sözleşmede
      talep edilen şartlar dâhilinde yerine getireceklerini beyan ederler.
    </p>
    1.<strong>SORUMLULUKLAR</strong> <br />
    a.Firma, fiyatlar ve sunulan ürün ve hizmetler üzerinde değişiklik yapma
    hakkını her zaman saklı tutar.<br />

    b.Firma, üyenin sözleşme konusu hizmetlerden, teknik arızalar dışında
    yararlandırılacağını kabul ve taahhüt eder.<br />
    ...
    teşvik eden içerikler üretmeyeceğini, paylaşmayacağını kabul eder. Aksi
    halde oluşacak zarardan tamamen kendisi sorumludur ve bu durumda ‘Site’
    ...
    kullanıcı hesapları ile ilgili bilgi talepleri gelirse paylaşma hakkını
    saklı tutar.<br />

    e.Sitenin üyelerinin birbirleri veya üçüncü şahıslarla olan ilişkileri kendi
    sorumluluğundadır.<br />

    2. <strong>Fikri Mülkiyet Hakları</strong><br />
    ...
    kopyalanamaz, sunulamaz ve/veya aktarılamaz. Site’nin bütünü veya bir kısmı
    diğer bir internet sitesinde izinsiz olarak kullanılamaz.<br />
    3. <strong>Gizli Bilgi </strong><br />
    3.1. Firma, site üzerinden kullanıcıların ilettiği kişisel bilgileri 3.
    Kişilere açıklamayacaktır. Bu kişisel bilgiler; kişi adı-soyadı, adresi,
    telefon numarası, cep telefonu, e-posta adresi gibi Kullanıcı’yı tanımlamaya
    ...
    resmi makamlara açıklama yapılmasının zorunlu olduğu durumlarda resmi
    makamlara açıklanabilecektir. 4. <strong>Garanti Vermeme:</strong><br />
    ...
    “MÜMKÜN OLDUĞU” TEMELDE SUNULMAKTA VE PAZARLANABİLİRLİK, BELİRLİ BİR AMACA
    UYGUNLUK VEYA İHLAL ETMEME KONUSUNDA TÜM ZIMNİ GARANTİLER DE DÂHİL OLMAK
    ÜZERE HİZMETLER VEYA UYGULAMA İLE İLGİLİ OLARAK (BUNLARDA YER ALAN TÜM
    BİLGİLER DÂHİL) SARİH VEYA ZIMNİ, KANUNİ VEYA BAŞKA BİR NİTELİKTE HİÇBİR
    GARANTİDE BULUNMAMAKTADIR.<br />

    5. <strong>Kayıt ve Güvenlik</strong><br />
    ...
    bilgilendirilmeksizin hesap kapatılabilecektir.<br />
    ...
    6. <strong>Mücbir Sebep</strong><br />
    ...
    lokavt ve salgın hastalıklar, altyapı ve internet arızaları, elektrik
    kesintisi gibi sebeplerden (aşağıda birlikte “Mücbir Sebep” olarak
    anılacaktır.) dolayı sözleşmeden doğan yükümlülükler taraflarca ifa edilemez
    hale gelirse, taraflar bundan sorumlu değildir. Bu sürede Taraflar’ın işbu
    Sözleşme’den doğan hak ve yükümlülükleri askıya alınır.<br />

    7. <strong>Sözleşmenin Bütünlüğü ve Uygulanabilirlik</strong><br />
    İşbu sözleşme şartlarından biri, kısmen veya tamamen geçersiz hale gelirse,
    sözleşmenin geri kalanı geçerliliğini korumaya devam eder.<br />

    8. <strong>Sözleşmede Yapılacak Değişiklikler</strong><br />
    ...
    tarihten itibaren geçerli olacaktır. Değişiklikleri takip etmek
    ...
    tebligatların geçerli sayılacağını kabul eder.<br />
    ...
    etmeyeceğini kabul eder.<br />

    Uyuşmazlıkların Çözümü<br />
    İşbu Sözleşme’nin uygulanmasından veya yorumlanmasından doğacak her türlü
    uyuşmazlığın çözümünde KahramanMaraş Adliyesi Mahkemeleri ve İcra Daireleri
    yetkilidir.<br />
  </div>
</template>
